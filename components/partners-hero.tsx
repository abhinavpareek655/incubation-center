...
import { Users, Globe, ChevronLeft, ChevronRight, Play, Pause, Building } from "lucide-react"
...
export default function Hero() {
  ...
  const slides = [
    ...
    {
      image: "/img14.jpg",
      alt: "Collaborative workspace with partners",
    },
    {
      image: "/img2.jpg",
      alt: "Joint innovation projects",
    },
    {
      image: "/img16.jpg",
      alt: "Partner networking events",
    },
    {
      image: "/img28.png",
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-6 border-y border-gray-200">
              <div className="text-center">
                ...
                <div className="text-lg font-semibold text-gray-900">50+ Partners</div>
                <div className="text-sm text-gray-600">Active Collaborations</div>
              </div>
              <div className="text-center">
                <Users className="h-8 w-8 mx-auto mb-2 text-indigo-600" />
                <div className="text-lg font-semibold text-gray-900">Government</div>
                <div className="text-sm text-gray-600">& Private Sector</div>
              </div>
              <div className="text-center">
                <Globe className="h-8 w-8 mx-auto mb-2 text-indigo-600" />
                <div className="text-lg font-semibold text-gray-900">Global Reach</div>
                <div className="text-sm text-gray-600">International Network</div>
              </div>
            </div>
          </div>
