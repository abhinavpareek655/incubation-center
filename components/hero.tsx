      ...
      <div className="space-y-8 lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center lg:space-y-0">
        ...
        <div className="space-y-6 md:space-y-8 text-center lg:text-left">
          <div>
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 mb-6 md:mb-8 leading-relaxed px-4 sm:px-0">
              Transforming innovative ideas into successful startups through mentorship, funding, and world-class
              resources
            </p>
          </div>
        ...
        {/* Slideshow Side - Mobile optimized */}
