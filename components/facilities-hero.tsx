...
import { Play, Pause, Building, Users, Clock, ChevronLeft, ChevronRight } from "lucide-react"
...
export default function FacilitiesHero() {
  ...
  const slides = [
    {
      image: "/img1.jpg",
      alt: "Modern co-working space overview",
    },
    {
      image: "/img14.jpg",
      alt: "State-of-the-art technology lab",
    },
    {
      image: "/img2.jpg",
    ...
    {
      image: "/img17.jpg",
      alt: "Relaxation and networking areas",
    },
    {
      image: "/image.jpg",
      alt: "Outdoor workspace and terrace",
    },
  ]
      ...
      <div className="container px-4">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          <div className="space-y-6 md:space-y-8">
            <div>
              <div className="inline-flex items-center px-2 py-1 rounded-full bg-teal-100 text-teal-800 text-xs md:text-sm font-medium mb-3 md:mb-4">
            ...
            {/* Facility Highlights */}
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 py-4 md:py-6 border-y border-gray-200">
              <div className="text-center">
                <Building className="h-6 w-6 md:h-8 md:w-8 mx-auto mb-1 md:mb-2 text-teal-600" />
                <div className="text-base md:text-lg font-semibold text-gray-900">50,000 sq ft</div>
                <div className="text-xs md:text-sm text-gray-600">Modern Space</div>
              </div>
              <div className="text-center">
                <Users className="h-6 w-6 md:h-8 md:w-8 mx-auto mb-1 md:mb-2 text-teal-600" />
                <div className="text-base md:text-lg font-semibold text-gray-900">200+ Desks</div>
                <div className="text-xs md:text-sm text-gray-600">Co-working Space</div>
              </div>
              <div className="text-center hidden md:block">
                <Clock className="h-8 w-8 mx-auto mb-2 text-teal-600" />
                <div className="text-lg font-semibold text-gray-900">24/7 Access</div>
