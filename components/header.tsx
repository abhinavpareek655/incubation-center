                  ...
                  <li>
                    <NavigationMenuLink asChild>
                      ...
                      >
                        ...
                        <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                          Meet our experienced mentors and staff
                        </p>
                      </a>
                    </NavigationMenuLink>
                  </li>
                  ...
                  <li>
                    <NavigationMenuLink asChild>
                      <a
                        ...
                        className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
                      >
                        <div className="text-sm font-medium leading-none">Accelerator Program</div>
                        <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                          3-month intensive program for early-stage startups
                        </p>
                      </a>
                    </NavigationMenuLink>
                  </li>
                  ...
                  <li>
                    <NavigationMenuLink asChild>
                      <a
                        ...
                        className="block select-none space-y-1 rounded-md p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground"
                      >
                        <div className="text-sm font-medium leading-none">Funding Support</div>
                        <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                  ...
                  <li>
                    <NavigationMenuLink asChild>
                      ...
                      >
                        ...
                        <p className="line-clamp-2 text-sm leading-snug text-muted-foreground">
                          Regular skill-building sessions and masterclasses
                        </p>
                      </a>
                    </NavigationMenuLink>
                  </li>
      ...
      {isSearchOpen && (
        <div className="border-t bg-white p-4">
          <div className="container">
            <Input type="search" placeholder="Search..." className="max-w-md" autoFocus />
          </div>
        </div>
      )}
    </header>
