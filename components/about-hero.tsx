          ...
          <div className="space-y-6 md:space-y-8">
            <div>
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-6 leading-relaxed">
                Empowering entrepreneurs since 2021, we've built a thriving ecosystem where innovation meets opportunity
              </p>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-6 py-4 border-y border-gray-200">
              <div className="text-center">
                <div className="text-xl md:text-2xl font-bold text-blue-600 mb-1">50+</div>
                <div className="text-sm text-gray-600">Startups Incubated</div>
              </div>
              <div className="text-center">
                <div className="text-xl md:text-2xl font-bold text-blue-600 mb-1">85%</div>
                <div className="text-sm text-gray-600">Success Rate</div>
              </div>
              <div className="text-center">
                <div className="text-xl md:text-2xl font-bold text-blue-600 mb-1">₹5.3Cr+</div>
                <div className="text-sm text-gray-600">Funding Raised</div>
              </div>
            </div>

            <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 md:px-8 md:py-3">
              Our Story
